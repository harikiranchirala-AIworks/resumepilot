...
export function DynamicProgressHeader({
  ...
  return (
    <div className="bg-white border-b border-slate-200 p-4 sm:px-8 space-y-3.5 shadow-2xs">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div className="flex items-center gap-3">
          {onToggleMobileSidebar && (
            <button
              ...
              className="lg:hidden p-2 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-700 transition-colors shadow-2xs"
        ...
        <div className="flex flex-wrap items-center gap-2.5">
          ...
          <button
            type="button"
            onClick={onRunDemo}
            className="px-3.5 py-2 rounded-xl bg-amber-50 hover:bg-amber-100 text-amber-900 font-bold border border-amber-300 flex items-center gap-1.5 transition-all shadow-2xs active:scale-95 text-xs"
      ...
      <div className="p-3 rounded-2xl bg-gradient-to-r from-slate-50 via-indigo-50/40 to-slate-50 border border-slate-200 space-y-2">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1 text-xs font-bold text-slate-800">
          ...
          <span className="text-indigo-600 font-black text-sm">{progressPercent}% Tailored</span>
        </div>
