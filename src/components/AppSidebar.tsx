      ...
      >
        ...
        <div className="p-4 border-b border-slate-100 space-y-4">
          ...
          <div
            ...
            className="p-3 rounded-2xl bg-gradient-to-r from-indigo-50/90 via-slate-50 to-purple-50/60 border border-indigo-100 hover:border-indigo-300 transition-all cursor-pointer group shadow-2xs"
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2.5">
          ...
          {navItems.map((item) => {
            ...
            return (
              <button
                ...
                className={`w-full p-2.5 rounded-xl text-left transition-all duration-200 flex items-center justify-between group ${
                  isActive
              ...
              <div className="flex items-center gap-3 min-w-0">
                ...
                <div className="min-w-0">
                  ...
                  <span className={`text-[10px] block truncate font-medium ${isActive ? "text-indigo-100" : "text-slate-600"}`}>
                    {item.description}
                  </span>
                </div>
              </div>
        ...
        <div className="p-3 bg-white rounded-2xl border border-slate-200 shadow-2xs space-y-2.5">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-[11px] font-bold text-slate-800">Target ATS Match</span>
            </div>
          ...
          <div className="space-y-1.5">
            <div>
              <div className="flex justify-between text-[10px] text-slate-500 font-semibold mb-0.5">
                ...
                <span className="font-bold text-slate-700">{impactScore}%</span>
              </div>
            ...
            <div>
              <div className="flex justify-between text-[10px] text-slate-500 font-semibold mb-0.5">
                ...
                <span className="font-bold text-slate-700">{keywordScore}%</span>
              </div>
              <div className="w-full bg-slate-100 h-1.5 rounded-full overflow-hidden">
