...
const TOUR_SLIDES = [
  {
    ...
    subtitle: "Start one application around the role you want",
    icon: Target,
    badge: "Step 1",
    badgeColor: "bg-cyan-500/15 text-cyan-700 dark:text-cyan-300 border-cyan-300 dark:border-cyan-700",
    color: "from-cyan-500 to-teal-500",
    description:
      "Paste the job description you want to pursue. We’ll organize your résumé and preparation around this target.",
    highlights: [
      "Target Job Description scraper & archetype scanner",
      "Résumé–JD alignment estimate",
      "A clear next step for your application",
    ],
    targetScreen: "jd" as const,
  },
  {
    step: "02 / 04",
    title: "Improve your résumé",
    subtitle: "Use verified evidence to strengthen one statement",
    icon: LayoutGrid,
    badge: "Step 2",
    badgeColor: "bg-indigo-500/15 text-indigo-700 dark:text-indigo-300 border-indigo-300 dark:border-indigo-700",
    color: "from-indigo-500 to-cyan-500",
    description:
      "Add your experience, review the résumé, and improve a specific statement with facts you can verify. The grounded rewrite keeps the original unchanged until you explicitly create a revision.",
    highlights: [
      "Original statement, suggested wording, and factual trace",
      "Edit, approve, or discard controls",
      "Explicit local résumé revision",
    ],
  ...
  },
  {
    ...
    subtitle: "Practice answers for the target job",
    icon: MessageSquare,
    badge: "Step 3",
    badgeColor: "bg-amber-500/15 text-amber-700 dark:text-amber-300 border-amber-300 dark:border-amber-700",
    color: "from-amber-500 to-orange-500",
    description:
      "Use the target job to practice interview questions and organize your application preparation.",
    highlights: [
  ...
  {
    step: "04 / 04",
    title: "Your application path is clear",
    subtitle: "Add résumé → target job → improve → prepare",
    icon: Sparkles,
    badge: "Step 1: Start Here",
    badgeColor: "bg-cyan-500/15 text-cyan-700 dark:text-cyan-300 border-cyan-300 dark:border-cyan-700",
    color: "from-cyan-500 to-teal-500",
    description:
      "Start with a target job, add your résumé, improve one statement with verified evidence, then prepare for the interview.",
    highlights: [
      "Apply: target job, experience, résumé improvement, and tracking",
      "Prepare: interview questions and STAR practice",
      "Grow: focused learning when you need it",
    ],
    targetScreen: "jd" as const,
  },
];
